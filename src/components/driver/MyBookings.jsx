...
import { MapPin, Navigation, Calendar, DollarSign, Download, Eye } from 'lucide-react';
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Track your rides and earnings</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="glass-effect p-6 rounded-xl">
          ...
          <div>
            ...
            <p className="text-2xl font-bold mt-1">{driverBookings.length}</p>
          </div>
        </div>
      </div>
                ...
                <div className="flex flex-col lg:items-end gap-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    {booking.status === 'completed' && (
                      <button className="flex items-center px-3 py-1 bg-green-600 hover:bg-green-700 rounded-lg text-sm transition-colors">
