                ...
                <div key={ticket.id} className="glass-effect p-6 rounded-xl">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-3 py-1 rounded-full text-xs font-medium bg-purple-900/20 text-purple-400 capitalize">
                        {ticket.category}
                      </span>
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                  ...
                  <div className="flex justify-end">
                    <button className="flex items-center px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg text-sm transition-colors">
